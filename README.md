...
<div align="center">
  <h3>Guessing Game</h3>
 <p>Guessing Game is a simple game in which the user had limited guesses with which to guess a number between 1 & 100. It includes a hint button to assist a user with potential guesses, as well as a reset button to restart the game.</p>

 <p>View <img src="https://cdn-icons-png.flaticon.com/128/608/608258.png" alt="down arrow" width="15" height="15"/> Here</p>
 <a href="https://www.seejonesengineer.com/projects/guessinggame" target="_blank" >
         <img align="center" src="./GuessingGame.png" alt="Guessing Game" width="300" height="175"/>
      </a>
<div>
<!-- Footer -->
